...
class LeafletDrawWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::moduleHandler()->alter('bbox_map', $map, $items);
    $map = $this->getSetting('map');

    $element['#attached']['drupalSettings']['bbox']['map'] = $map;
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $elements['map'] = [
      '#type' => 'textfield',
      '#default_value' =>  $this->getSetting('map'),
      '#title' => 'Map URL',
    ];
  ...
  public function settingsSummary() {
    ...
    $summary[] = 'Map: ' . $this->getSetting('map');
